...
test('Verify Event Persistence (Create -> Home -> Re-enter)', async ({ page }) => {
  ...
  await expect(page.getByText('Persistent Event', { exact: false })).toBeVisible(); // Might be in title or body
